...
// https://cyanophage.github.io/playground.html?layout=jyou%3Dzmgpx%5Chiae-ftsnlv%27%2C.%3B%2Fqdcbw*rk&mode=ergo&lan=english&thumb=r
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_K,    HOME_H,   HOME_I,   HOME_A,           HOME_E,           KC_MINUS, KC_F,     HOME_T,         HOME_S,  HOME_N, HOME_L, KC_V,
